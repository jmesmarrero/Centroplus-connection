...
public interface IIncidenciaService {
    ...
    /**
     * Funcion para cambiar de estado la incidencia "ABIERTA,EN_ROCESO,CERRADA"
     * @param id identificador unico de la clase
     * @param estado estado en elq ue s encuentra la inciencia
     * @return Incidencia con el estado cambiado
     */
    Incidencia cambiarEstado(Long id, EstadoIncidencia estado);
